...
const int kCols = 5;  // accessible anywhere that arrayfunctions.h is included
// Function returns the average value in a double-subscripted array of integers
// how = 'r' for row average, 'c' for column average, else average of all vals
double Average(const int big_array[][kCols], int num_rows, char how = 'a',
               int which_one = 0);
